...
void main() {
    ...
    vec4 SourceSize = vec4(openfl_TextureSize, 1.0 / openfl_TextureSize);
    vec2 scale = openfl_TextureSize.xy * SourceSize.zw / 8;
    vec2 pos = fract(openfl_TextureCoordv * SourceSize.xy) - vec2(0.5, 0.5);
    vec2 coord = openfl_TextureCoordv - pos * SourceSize.zw;
    ...
    //                    -|G|H|I|x
    //                    -|-|x|x|-
    if (((eq(E,F) && eq(H,I)) || (eq(E,H) && eq(F,I))) == false) {
    ...
    //                    x|G|H|I|-
    //                    -|x|x|-|-
    if (((eq(D,E) && eq(G,H)) || (eq(D,G) && eq(E,H))) == false) {
    ...
    //                    -|-|H|I|-
    //                    -|-|-|-|-
    if (((eq(B,C) && eq(E,F)) || (eq(B,E) && eq(C,F))) == false) {
    ...
    //                    -|G|H|-|-
    //                    -|-|-|-|-
    if (((eq(A,B) && eq(D,E)) || (eq(A,D) && eq(B,E))) == false) {
