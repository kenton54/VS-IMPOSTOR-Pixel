...
class FlxG
{
	...
	/**
	 * Whether the game is currently focused.
	 */
	public static var isGameFocused(get, never):Bool;
	...
	static inline function get_isGameFocused():Bool
	{
		return @:privateAccess !game._lostFocus;
	}
}
